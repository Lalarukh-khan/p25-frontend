			...
			function createSelect(options) {
				...
				// if (selectContainer.innerHTML.trim() === '') {
					options.forEach(item => {
						...
						categoryName.textContent = item.sitename;
						categoryName.id = item.id;
						const locationName = document.createElement('p');
						locationName.className = 'manuffotn';
						locationName.textContent = item.sitelocation;
		...
		<div className="container">
			<div className="row mb-3">
				<div className="col-lg-3 col-md-3 col-sm-12">
					<button className="categbtn" onClick={addmatshow}>Site Manufacture</button>
				</div>
				...
				<div className="col-lg-10 col-md-10 col-sm-12">
					<div className="row  mb-3">
						<div className="col-lg-4 col-md-4 col-sm-12">
							<input type="text" id="mnfname" placeholder="Site Name" className="shpinput"/>
						</div>
						<div className="col-lg-4 col-md-4 col-sm-12">
							<input type="text" id="mnflocation" placeholder="Site Location" className="shpinput"/>
						</div>
						...
						<h5 className="h5heading mt-3 sccssmsg" id="matconfirm" style={{display: 'none'}}>Site Added Successfully!</h5>
					</div>
				</div>
