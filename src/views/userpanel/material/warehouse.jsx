...
export default function WarehouseInformation(){
	...
	useEffect(() => {
		loadshipments();
		document.getElementById("mainheadingtt").innerText = "Warehouse Information";
	}, []);
	const loadshipments = () => {
			...
			<div className="row mb-5" id="toshow" style={{display: "none"}}>
				<div className="col-lg-10 col-md-10 col-sm-12">
					<div className="row  mb-3">
						...
						<h5 className="h5heading mt-3 sccssmsg" id="matconfirm" style={{display: 'none'}}>Warehouse Added Successfully!</h5>
					</div>
				</div>
