...
export default function CreateRequisition(){
	...
	const userload = () => {
		...
		document.getElementById("mruser").value = user;
	}
	const loadlisiting = () => {
		axiosClient.get('/get-allreqlisiting')
		.then(({data}) => {
			console.log(data); 
		...
		<div className="container">
				...
				<div className="row" style={{marginTop: "100px"}}>
					<div className="col-lg-3 col-md-3 col-sm-3">
						...
						<button className="categbtn" disabled style={{background: "grey"}}>Submit</button>
					</div>
					<div className="col-lg-3 col-md-3 col-sm-3">
							<h5 className="h5heading">S/R Creator By: TVN Head</h5>
						<button className="categbtn" disabled style={{background: "grey"}}>Submit</button>
					</div>
					<div className="col-lg-3 col-md-3 col-sm-3">
					</div>
