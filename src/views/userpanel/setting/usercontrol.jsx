			...
			<div className="row mb-5">
					<div className="row  mb-3">
						<div className="col-lg-4 col-md-4 col-sm-12">
							<h6 className="h5hcntrl">Admin</h6>
							...
							<div className="row">
								...
								<div className="col-lg-1 col-md-1 col-sm-12">
									<input type="checkbox" id="add_material1" value="1"/>
								</div>
							</div>
							<div className="row">
								<div className="col-lg-11 col-md-11 col-sm-12">
								...
								<div className="col-lg-1 col-md-1 col-sm-12">
									<input type="checkbox" id="mcategory1"/>
								</div>
							</div>
							<div className="row">
								<div className="col-lg-11 col-md-11 col-sm-12">
							...
							<div className="row">
								...
								<div className="col-lg-1 col-md-1 col-sm-12">
									<input type="checkbox" id="manufacture1"/>
								</div>
							</div>
							<div className="row">
								<div className="col-lg-11 col-md-11 col-sm-12">
								...
								<div className="col-lg-1 col-md-1 col-sm-12">
									<input type="checkbox" id="shipment1"/>
								</div>
							</div>
							<div className="row">
								<div className="col-lg-11 col-md-11 col-sm-12">
								...
								<div className="col-lg-1 col-md-1 col-sm-12">
									<input type="checkbox" id="warehouse1"/>
								</div>
							</div>
							<div className="row">
								<div className="col-lg-11 col-md-11 col-sm-12">
							...
							<div className="row mb-3">
								...
								<div className="col-lg-1 col-md-1 col-sm-12">
									<input type="checkbox" id="sitereq1"/>
								</div>
							</div>
							<div className="row">
								<div className="col-lg-11 col-md-11 col-sm-12">
								...
								<div className="col-lg-1 col-md-1 col-sm-12">
									<input type="checkbox"  id="createreq1"/>
								</div>
							</div>
							<div className="row">
								<div className="col-lg-11 col-md-11 col-sm-12">
								...
								<div className="col-lg-1 col-md-1 col-sm-12">
									<input type="checkbox" id="requpdate1"/>
								</div>
							</div>
							<div className="row">
								<div className="col-lg-11 col-md-11 col-sm-12">
								...
								<div className="col-lg-1 col-md-1 col-sm-12">
									<input type="checkbox" id="userinfo1"/>
								</div>
							</div>
							<div className="row">
								<div className="col-lg-11 col-md-11 col-sm-12">
								...
								<div className="col-lg-1 col-md-1 col-sm-12">
									<input type="checkbox" id="rolecontrol1"/>
								</div>
							</div>
							</div>
							<button className="categbtn" id="adminbtn" onClick={UpdateAdmin}>Update</button>
						</div>
						<div className="col-lg-4 col-md-4 col-sm-12">
